...
- **🎨 Customizable** - Custom colors, size, and error correction
- **📱 Responsive Design** - Works on all devices
- **💾 Download QR Codes** - Export as PNG or SVG
- **🌐 Multiple Content Types** - Support for URLs, text, emails, WiFi, and more
...
- **QR Library:** qrcode.react or similar
- **Icons:** React Icons
- **Deployment:** Vercel
